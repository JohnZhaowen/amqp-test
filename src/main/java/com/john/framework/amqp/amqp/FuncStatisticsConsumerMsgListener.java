 ...
 * 该监听器用于统计延时信息
 */
public class FuncStatisticsConsumerMsgListener implements IMsgListener {

    private static final Logger LOG = LoggerFactory.getLogger(FuncStatisticsConsumerMsgListener.class);
    ...
    public FuncStatisticsConsumerMsgListener(TestCaseEnum testCaseEnum, Environment environment) {
