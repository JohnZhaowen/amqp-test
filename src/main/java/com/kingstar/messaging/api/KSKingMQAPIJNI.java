...
public class KSKingMQAPIJNI {
  ...
  public final static native void KSKingMQSPI_OnMessage(long jarg1, KSKingMQSPI jarg1_, String jarg2, byte[] jarg3, long jarg5, ErrorInfo jarg5_);
  public final static native void KSKingMQSPI_OnMessageSwigExplicitKSKingMQSPI(long jarg1, KSKingMQSPI jarg1_, String jarg2, byte[] jarg3, long jarg5, ErrorInfo jarg5_);
  ...
  public static void SwigDirector_KSKingMQSPI_OnMessage(KSKingMQSPI jself, String routingKey, byte[] pMsgbuf, long pErrorInfo) {
    jself.OnMessage(routingKey, pMsgbuf, (pErrorInfo == 0) ? null : new ErrorInfo(pErrorInfo, false));
  }
