...
public class KSKingMQSPI {
  ...
  public void OnMessage(String routingKey, byte[] pMsgbuf, ErrorInfo pErrorInfo) {
    if (getClass() == KSKingMQSPI.class) KSKingMQAPIJNI.KSKingMQSPI_OnMessage(swigCPtr, this, routingKey, pMsgbuf, ErrorInfo.getCPtr(pErrorInfo), pErrorInfo); else KSKingMQAPIJNI.KSKingMQSPI_OnMessageSwigExplicitKSKingMQSPI(swigCPtr, this, routingKey, pMsgbuf, ErrorInfo.getCPtr(pErrorInfo), pErrorInfo);
  }
